...
class QueryActor<K extends Serializable> extends UntypedActor {
  ...
  private Future<ActorRef> getActorRefFuture(K key) {
  ...
  private Future<Object> queryStateFuture(final QueryState<K> queryState) {
  ...
  private Future<Object> queryStateFutureWithFailover(final int tries, final QueryState<K> queryState) {
    @SuppressWarnings("unchecked")
